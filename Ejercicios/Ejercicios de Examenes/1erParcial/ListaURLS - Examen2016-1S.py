...
#Muestre los nombres o siglas de las universidades que aparecen en la lista (sin repetir).
universidades=[]
for sitio in lista:
    sitio=sitio.upper()
...
#Muestre la cantidad y los nombres/siglas de universidades de Ecuador que aparecen en la lista.
